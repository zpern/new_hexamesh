...
- [ ] **Step 1: 写单 Zone Triangle/Quad RED 测试**
...
- [ ] **Step 2: 写 Base、Zone、元素和坐标错误 RED 测试**
...
- [ ] **Step 5: 构建并运行 Release benchmark**
